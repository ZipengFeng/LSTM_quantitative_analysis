...
########################################################################
class ctaLSTM_V4_1(CtaTemplate):
    className = 'ctaLSTM_V4_1'
    ...
    # ----------------------------------------------------------------------
    def __init__(self, ctaEngine, setting, filepath='/home/chocolate/LSTM-source/models/models_1/models_1.tar.gz'):
        """Constructor"""
        super(ctaLSTM_V4_1, self).__init__(ctaEngine, setting)
        self.DATAS = []
...
# 对买一价和卖一价保持和tick中同样的名称，方便后续调用进行建仓/平仓
        ...
        if self.count >= 26:
            ...
            # self.writeCtaLog(u"预测准确率分别为：" + str(self.acc_1) + str(self.acc_2) + str(self.acc_3) + str(self.acc_4) + str(self.acc_5))
