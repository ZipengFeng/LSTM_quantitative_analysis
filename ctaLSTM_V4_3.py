...
########################################################################
class ctaLSTM_V4_3(CtaTemplate):
    className = 'ctaLSTM_V4_3'
    ...
    def __init__(self, ctaEngine, setting, filepath=None):
        """Constructor"""
        super(ctaLSTM_V4_3, self).__init__(ctaEngine, setting)
        self.DATAS = []
...
# 对买一价和卖一价保持和tick中同样的名称，方便后续调用进行建仓/平仓
    ...
    def pred(self, seq_data):
        ...
        # 创建会话，加载模型
        path = "/home/chocolate/LSTM-source/models/model_5.1/"
        # 创建会话，加载模型
